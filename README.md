...
* 用 EFF 的 No Censorship 图片替换您的聊天头像。
* 加入 EFF 的[Twibbon](http://twibbon.com/join/Say-No-to-Online-Censorship)活动。
* [成为 EFF 的一员](https://www.eff.org/friends)，帮助我们继续为您的权利而战！

[![](https://www.eff.org/files/Button_no_censorship_collection.jpg)](https://www.eff.org/pages/alternate-no-censorship-buttons)
[下载“无审查”按钮！](https://www.eff.org/pages/alternate-no-censorship-buttons)
#### 大声反对审查
